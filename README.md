...
<table>
  <tr>
    <td width="50%">
      <img src="assets/screenshots/register.png" alt="halaman Registrasi" width="100%">
    </td>
    <td width="50%">
  ...
  <tr>
    <td width="50%">
      <img src="assets/screenshots/login.png" alt="halaman Login" width="100%">
    </td>
    <td width="50%">
...
kalian dapat melihat informasi mengenai penjelasan aplikasi ini, portofolio pembuat aplikasi ini dan siapa pengembang di balik pembuatan aplikasi **Savings Tracker**.
